...
TODO: Copy from the multipaz project with minor amendments. Needs work to explain the Multipaz Extras package goals).
...
- [CONTRIBUTING.md](https://github.com/openwallet-foundation/multipaz/blob/main/CONTRIBUTING.md) for how to get involved with the project and send PRs.
- [CODE-OF-CONDUCT.md](CODE-OF-CONDUCT.md) for the policies and rules around collaboration.
- [CODING-STYLE.md](https://github.com/openwallet-foundation/multipaz/blob/main/CODING-STYLE.md) for guidelines on writing code to be included in the project.
- [TESTING.md](TESTING.md) explains our approach to unit and manual testing.
- [DEVELOPER-ENVIRONMENT.md](https://github.com/openwallet-foundation/multipaz/blob/main/DEVELOPER-ENVIRONMENT.md) for how to set up your system for building Multipaz.
...
For a fully-fledged mDL wallet, our current answer is to use the `testappextras`
